        ...
        <section id="About">
            <main>
                ...
                <div className="grid-container">
                    ...
                    <motion.div className="card-info div5">
                        <h3></h3>
                    </motion.div>
                    <motion.div
                        initial={{ x: -100, opacity: 0 }}
